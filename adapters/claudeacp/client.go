...
func (c *Client) drainStderr(r io.Reader) {
	...
	for scanner.Scan() {
		...
		// protocol frames. A future revision could surface these as a
		// low-priority runtimeevents kind; today they are intentionally
		// dropped rather than misclassified as protocol activity.
		_ = scanner.Text()
	}
}
